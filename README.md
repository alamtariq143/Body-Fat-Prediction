# Demo of the Project
https://youtu.be/ThviePgoUtY

# Body-Fat-Prediction
An Internship Project Body Fat Estimator Deployed on Azure Cloud Platform.
The project "Body Fat Estimator" tends to estimate percentage of body fat in human body based on parameters such as weight, hip-size, chest-size, and many more.
